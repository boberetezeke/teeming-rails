...
describe Election do
  ...
  let(:ranked_choice_answer_1)      { FactoryGirl.create(:answer, question: ranked_choice_question, text: '0:::1:::2:::3', order_index: 1, answerable: FactoryGirl.create(:vote_completion) ) }
  let(:ranked_choice_answer_2)      { FactoryGirl.create(:answer, question: ranked_choice_question, text: '0:::1:::3:::2', order_index: 2, answerable: FactoryGirl.create(:vote_completion)) }
  let(:ranked_choice_answer_3)      { FactoryGirl.create(:answer, question: ranked_choice_question, text: '1:::0:::2:::3', order_index: 3, answerable: FactoryGirl.create(:vote_completion)) }
  let(:ranked_choice_answer_3dq)    { FactoryGirl.create(:answer, question: ranked_choice_question, text: '1:::0:::2:::3', order_index: 3, answerable: FactoryGirl.create(:vote_completion, :disqualified)) }

  # adding in these two requires a second round where 3's vote gives the election to 2 (because of the 2nd place vote for 2)
  let(:ranked_choice_answer_4)      { FactoryGirl.create(:answer, question: ranked_choice_question, text: '1:::0:::2:::3', order_index: 4, answerable: FactoryGirl.create(:vote_completion)) }
  let(:ranked_choice_answer_5)      { FactoryGirl.create(:answer, question: ranked_choice_question, text: '2:::1:::0:::3', order_index: 5, answerable: FactoryGirl.create(:vote_completion)) }

  # adding in these two requires a third round where 3's vote gives the election to 2 (because of the 2nd place vote for 2)
  let(:ranked_choice_answer_6)      { FactoryGirl.create(:answer, question: ranked_choice_question, text: '3:::1:::2:::0', order_index: 6, answerable: FactoryGirl.create(:vote_completion)) }
  let(:ranked_choice_answer_7)      { FactoryGirl.create(:answer, question: ranked_choice_question, text: '1:::2:::0:::3', order_index: 7, answerable: FactoryGirl.create(:vote_completion)) }
  let(:ranked_choice_answer_8)      { FactoryGirl.create(:answer, question: ranked_choice_question, text: '3:::1:::0:::2', order_index: 8, answerable: FactoryGirl.create(:vote_completion)) }
  let(:ranked_choice_answer_9)      { FactoryGirl.create(:answer, question: ranked_choice_question, text: '3:::1:::0:::2', order_index: 9, answerable: FactoryGirl.create(:vote_completion)) }

  let(:empty_ranked_choice_answer)  { FactoryGirl.create(:answer, question: ranked_choice_question, text: '-:::-:::-:::-', order_index: 1, answerable: FactoryGirl.create(:vote_completion)) }

  let(:incomplete_ranked_choice_answer_1) { FactoryGirl.create(:answer, question: ranked_choice_question, text: '0:::1:::-:::-', order_index: 1, answerable: FactoryGirl.create(:vote_completion)) }
  let(:incomplete_ranked_choice_answer_2) { FactoryGirl.create(:answer, question: ranked_choice_question, text: '0:::1:::-:::2', order_index: 2, answerable: FactoryGirl.create(:vote_completion)) }
  let(:incomplete_ranked_choice_answer_3) { FactoryGirl.create(:answer, question: ranked_choice_question, text: '1:::0:::2:::3', order_index: 3, answerable: FactoryGirl.create(:vote_completion)) }

  # adding in these two requires a second round where 3's vote gives the election to 2 (because of the 2nd place vote for 2)
  let(:incomplete_ranked_choice_answer_4) { FactoryGirl.create(:answer, question: ranked_choice_question, text: '1:::0:::2:::3', order_index: 4, answerable: FactoryGirl.create(:vote_completion)) }
  let(:incomplete_ranked_choice_answer_5) { FactoryGirl.create(:answer, question: ranked_choice_question, text: '0:::1:::-:::2', order_index: 5, answerable: FactoryGirl.create(:vote_completion)) }
  let(:incomplete_ranked_choice_answer_6) { FactoryGirl.create(:answer, question: ranked_choice_question, text: '1:::0:::2:::3', order_index: 6, answerable: FactoryGirl.create(:vote_completion)) }
  let(:incomplete_ranked_choice_answer_7) { FactoryGirl.create(:answer, question: ranked_choice_question, text: '-:::-:::0:::-', order_index: 7, answerable: FactoryGirl.create(:vote_completion)) }
  let(:incomplete_ranked_choice_answer_8) { FactoryGirl.create(:answer, question: ranked_choice_question, text: '-:::1:::0:::-', order_index: 8, answerable: FactoryGirl.create(:vote_completion)) }

  let(:multiple_choice_answer_1)    { FactoryGirl.create(:answer, question: multiple_choice_question, text: 'checkbox choice 1', answerable: FactoryGirl.create(:vote_completion)) }
  let(:multiple_choice_answer_2)    { FactoryGirl.create(:answer, question: multiple_choice_question, text: 'checkbox choice 2', answerable: FactoryGirl.create(:vote_completion)) }
  let(:multiple_choice_answer_3)    { FactoryGirl.create(:answer, question: multiple_choice_question, text: 'checkbox choice 2', answerable: FactoryGirl.create(:vote_completion)) }
  let(:multiple_choice_answer_4)    { FactoryGirl.create(:answer, question: multiple_choice_question, text: 'checkbox choice 1:::checkbox choice 2', answerable: FactoryGirl.create(:vote_completion)) }
