class Message < ApplicationRecord
  ...
  def rendered_body(message_recipient, unsubscribe_path, errors: [])
    ...
    modified_body = body.gsub(/%(.[^%]*?)%/) do
      ...
      case directive
        when /logo/
          "<div style=\"text-align: center;\"><a href=\"https://ourrevolutionmn.com\"><img width=\"250px\" height=\"250px\" src=\"https://ourrevolutionmn.herokuapp.com/images/logo-organize-mn-450.png\"></a></div>"
